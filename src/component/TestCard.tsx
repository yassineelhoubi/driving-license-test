...
export const TestCard = ({ type, image, unavailable, onClick }: Props) => {
    return (
        <div onClick={onClick} className="cursor-pointer">
            <a className="group h-96 block bg-gray-100 rounded-lg overflow-hidden shadow-lg relative mb-2 lg:mb-3">
